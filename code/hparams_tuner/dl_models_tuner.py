...
class DLModelTuner:
    ...
    def _cross_validation(self):
        ...
        train_config = {
            ...
            "patience": [10],
            "seed": [self.seed],
            "batch_size": [64, 128] if self.model_id in DL_MODELS_TRANSFORMER_BASED else [32, 64],
            "num_epochs": [100, 200] if self.model_id in DL_MODELS_TRANSFORMER_BASED else [30, 50]
        }

        if self.opt_metric == 'balanced_accuracy':
            direction = "maximize" 
        elif self.opt_metric == 'loss':
            direction = "minimize"
