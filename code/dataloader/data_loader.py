...
class TabularDataset(Dataset):
    ...
    Attributes:
        features (np.ndarray): A numpy array containing the input features. for images, 2D arrays (grayscale) expected per item
        labels (np.ndarray, optional): Labels corresponding to the input features.
